 ...
 * on a specific library. Vanilla-style, basicallu.
 */

import { createElement } from "../utils.js";

export function Card({ class: className, style, ...props }, ...children) {
  return createElement("div", { class: `card border rounded-lg overflow-hidden shadow-lg ${className}`, style, ...props }, ...children);
}

export function CardHeader({ class: className, style, ...props }, ...children) {
  return createElement("div", { class: `card-header p-4 ${className}`, style, ...props }, ...children);
}

export function CardTitle({ class: className, style, ...props }, children) {
  return createElement("h2", { class: `card-title font-bold text-lg mb-2 ${className}`, style, ...props }, children);
}

export function CardDescription({ class: className, style, ...props }, children) {
  return createElement("p", { class: `card-description text-gray-600 mb-2 ${className}`, style, ...props }, children);
}

export function CardContent({ class: className, style, ...props }, ...children) {
  return createElement("div", { class: `card-content p-4 ${className}`, style, ...props }, ...children);
}

export function CardFooter({ class: className, style, ...props }, ...children) {
  return createElement("div", { class: `card-footer p-4 border-t ${className}`, style, ...props }, ...children);
}

export function CardImage({ src, alt, class: className, style, ...props }) {
  return createElement("img", { src, alt, class: `card-image ${className}`, style, ...props });
}
